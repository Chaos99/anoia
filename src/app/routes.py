...
try:
  if (os.environ['DEBUG']):
      client = MongoClient("mongodb://"+os.environ['DBUSERNAME']+":"+os.environ['DBUSERPW']+"@localhost:27017/test?authSource=admin") #host uri
except:
  client = MongoClient("mongodb://"+os.environ['DBUSERNAME']+":"+os.environ['DBUSERPW']+"@mongo:27017/test?authSource=admin") #host uri
